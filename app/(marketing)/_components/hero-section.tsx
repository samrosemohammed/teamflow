...
import HeroLight from "@/public/teamflow-light.png";
import HeroDark from "@/public/teamflow-dark.png";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  TailFlow organized conversations into channels with threads,
