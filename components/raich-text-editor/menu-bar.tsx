...
export const MenuBar = ({ editor }: MenuBarProps) => {
  const editorState = useEditorState({
    ...
    selector: ({ editor }) => {
      ...
      return {
        ...
        isOrderList: editor.isActive("orderList"),
  ...
  return (
    <div className="border border-input border-t-0 border-x-0 rounded-top-lg p-2 bg-card flex flex-wrap gap-1 items-center">
      <TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Toggle
                ...
                className={cn(
                  editorState?.isOrderList && "bg-muted text-muted-foreground"
                )}
              >
                <ListOrdered />
              </Toggle>
